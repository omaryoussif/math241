...
```{r, eval = F}
bk_jan <- read_csv("https://s3.amazonaws.com/biketown-tripdata-public/2017_01.csv")
bk_jul <- read_csv("https://s3.amazonaws.com/biketown-tripdata-public/2017_07.csv")
bk_nov <- read_csv("https://s3.amazonaws.com/biketown-tripdata-public/2017_11.csv")
...
biketown_dt %>%
  ...
  facet_wrap(~ month(StartDate, label = T), nrow = 3) +
