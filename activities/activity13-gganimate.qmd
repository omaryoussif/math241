...
freedom <- read_csv(here::here("Github/math241/activities/freedom.csv"), na = "-")
...
-   **Demo:**: create a simple static line plots of your country of choice civil liberty score over time
...
freedom_ranked %>%
  ...
  ggplot(mapping = aes(x = year, y = rank_in_year, color = civil_liberty)) +
  geom_point() +
  geom_line() +
  labs(title = "Freedom House's Civil Liberty Analysis of Egypt",
       subtitle = "Data sourced from the Freedom House and ranges from 1990-2022",
       y = "Civil Liberty Country Rank", 
       x = "Year",
       color = "Civil Liberty Score") +
...
freedom_ranked %>%
  ...
  ggplot(mapping = aes(x = rank_in_year, y = country)) +
  facet_wrap( ~ year) +
  geom_col(position = "stack") +
  labs(title = "Freedom House's Civil Liberty Analysis",
       subtitle = "Data sourced from the Freedom House and for 1990, 2000, and 2010",
       y = "Country", 
       x = "Rank",
       color = "")
